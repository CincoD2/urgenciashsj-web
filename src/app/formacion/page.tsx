    ...
    <div className="space-y-6">
      <header className="space-y-3">
        ...
        <p className="text-slate-600">
          A continuación se relacionan algunos de los cursos y masters que complementan la formación
          recibida a través del programa de formación sanitaria especializada (MIR), para completar
          la formación básica en urgencias y emergencias.
        </p>
      </header>
